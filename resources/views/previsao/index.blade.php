        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content modal-glass">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel"><i class="fa fa-clock-rotate-left"></i> Histórico de
                        pesquisas</h1>
                ...
                <div class="modal-body">
                    ...
                    <div id="listar-historicos" class=" mt-3 gap-2 d-flex  p-1 flex-column overflow-auto h-60vh">
                        ...
                        @if (count($historicos_pesquisas) == 0)
                            <p>Não há nenhum histórico de pesquisas no momento</p>
                        @endif
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2  d-flex flex-column ">
                                            ...
                                            <div class="d-flex gap-1 flex-wrap">
                                                <button class="btn btn-success " title="Pesquisar cidade"><i
                                ...
                                <div class="previsao-atual mt-2 p-2">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex flex-row gap-2 mt-2">
                                            @if (!is_null($current['descricao_traduzida']))
                                                <span class="text-bold">{{ ucfirst($current['descricao_traduzida']) }}</span>
                                            @else
